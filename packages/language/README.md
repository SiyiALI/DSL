...
- [src/board-race.langium](src/board-race.langium) -  The grammar definition of your language
- [src/board-race-module.ts](src/board-race-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/board-race-validator.ts](src/board-race-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/board-race.monarch.ts](src/syntaxes/board-race.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/board-race.tmLanguage.json](syntaxes/board-race.tmLanguage.json) - Textmate based syntax highlighting instructions.
